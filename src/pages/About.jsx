    ...
    <AnimatedSection className="flex min-h-screen items-center bg-transparent px-6 py-24">
      ...
      <div className="mx-auto w-full max-w-5xl rounded-2xl border border-white/10 bg-white/5 p-10 backdrop-blur-xl">
        ...
        <p className="mt-5 text-slate-300">
          ...
          operations and deliver digital products with speed and confidence.
        </p>
        <p className="mt-4 text-slate-300">
          We blend strategy, engineering excellence, and governance to create durable outcomes for technology
          leaders building their next generation of platforms.
        </p>
      </div>
    </AnimatedSection>
  );
